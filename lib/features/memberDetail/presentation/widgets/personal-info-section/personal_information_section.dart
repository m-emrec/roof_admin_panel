...
import 'package:roof_admin_panel/features/memberDetail/presentation/widgets/personal-info-section/personal_information_item.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              PersonalInformationItem(
                title:
                    LocaleKeys.memberDetailView_personalInfo_phoneNumber.tr(),
                children: [
                  Text(
                    member?.phoneNumber ?? "",
                  ),
              ...
              Wrap(
                ...
                children: [
                  PersonalInformationItem(
                    title: LocaleKeys.memberDetailView_personalInfo_livingCity
                        .tr(),
                    children: [
                      Text(
                  ...
                  // work city
                  PersonalInformationItem(
                    title: LocaleKeys.memberDetailView_personalInfo_workingCity
                        .tr(),
                    children: [
                      Text(
